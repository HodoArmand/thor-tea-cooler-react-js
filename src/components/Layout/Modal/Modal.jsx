...
function Modal() {
    ...
    return (
        <>
            <section id="infoModal" className={(data.isOpen && data.type === 'info' ? 'z-[1000]' : '!hidden -z-10 ') + " modalSection"}>
            ...
            <section id="callbackModal" className={(data.isOpen && data.type === 'callback' ? 'z-[1000]' : '!hidden -z-10 ') + " modalSection"}>
                <div className="modalWrapper">
                    <div className="modalCard">
                        <div className="modalHeader">
                            <div className="inline-flex space-x-2 text-gray-800 dark:text-white">
                                <img src={SvgLibrary.alertOctagon} className="injectable inline icon-md" alt="!" />
                                <h3 id="infoModalTitle" className="font-bold">
                                    {data.title}
                                </h3>
                            </div>
                        ...
                        <div className="p-4 overflow-y-auto space-y-4">
                            <p id="infoModalDesc" className="mt-1 text-gray-800 dark:text-gray-400">
                                {data.desc}
                            </p>
                        </div>
                        <div className="flex justify-end items-center border-t dark:border-gray-700 rounded-b-lg">
                            <button type="button" onClick={() => data.callbackFunction()} className="modalButton">
